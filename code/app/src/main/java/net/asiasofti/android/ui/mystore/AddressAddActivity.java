...
public class AddressAddActivity extends Activity
{
  ...
  public void SendCityData()
  {
    ...
    localHashMap.put("true_name", this.editAddressName.getText().toString());
    localHashMap.put("area_id", this.city_id);
    localHashMap.put("city_id", this.area_id2);
    localHashMap.put("area_info", this.editAddressInfo.getText().toString());
    localHashMap.put("address", this.editJieDaoAddress.getText().toString());
    localHashMap.put("tel_phone", this.editAddressTelPhone.getText().toString());
    localHashMap.put("mob_phone", this.editAddressMobPhone.getText().toString());
    ...
    if ((this.editAddressTelPhone.getText().toString().equals("")) || (this.editAddressTelPhone.getText().toString().equals("null")) || (this.editAddressTelPhone.getText().toString() == null))
    {
      Toast.makeText(this, "固定电话不能为空", 0).show();
      return;
    }
    RemoteDataHandler.asyncPost2(Constants.URL_ADDRESS_ADD, localHashMap, new RemoteDataHandler.Callback()
    {
      public void dataLoaded(ResponseData paramAnonymousResponseData)
      {
        if (paramAnonymousResponseData.getCode() == 200)
        {
          ...
          if (str1.contains("address_id"))
          {
            ...
            AddressAddActivity.this.sendBroadcast(localIntent);
          ...
          try
          {
            ...
            if (str2 != null)
              Toast.makeText(AddressAddActivity.this, str2, 0).show();
            return;
          }
        ...
        Toast.makeText(AddressAddActivity.this, "数据加载失败，请稍后重试", 0).show();
      }
    });
  }
  ...
  public void loadingCityData(String paramString)
  {
    ...
    RemoteDataHandler.asyncPost2(Constants.URL_GET_CITY, localHashMap, new RemoteDataHandler.Callback()
    {
      public void dataLoaded(ResponseData paramAnonymousResponseData)
      {
        if (paramAnonymousResponseData.getCode() == 200)
        {
          ...
          try
          {
            ArrayList localArrayList = CityList.newInstanceList(new JSONObject(str1).getString("area_list"));
            AddressAddActivity.this.adapter.setDatas(localArrayList);
...
//              return;
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.textEditAddressInfo.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        if (AddressAddActivity.this.flag)
        {
          ...
          AddressAddActivity.this.linearLayoutSelectCity.setVisibility(0);
          return;
        }
        ...
        String str = AddressAddActivity.this.textCityID.getText().toString() + AddressAddActivity.this.textRegionID.getText().toString() + AddressAddActivity.this.textAddressID.getText().toString();
    ...
    this.textCityID.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        AlertDialog.Builder localBuilder = new AlertDialog.Builder(AddressAddActivity.this);
        final ListView localListView = new ListView(AddressAddActivity.this);
        ...
        localListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
          ...
          {
            CityList localCityList = (CityList)localListView.getItemAtPosition(paramAnonymous2Int);
            AddressAddActivity.this.area_id1 = localCityList.getArea_id();
            AddressAddActivity.this.textCityID.setText(localCityList.getArea_name());
            AddressAddActivity.this.textRegionID.setText("");
            AddressAddActivity.this.textAddressID.setText("");
            alt.dismiss();
...
//            localBuilder.
    ...
    this.textRegionID.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        if ((AddressAddActivity.this.textCityID.getText().toString().equals("")) || (AddressAddActivity.this.textCityID.getText().toString().equals("null")) || (AddressAddActivity.this.textCityID.getText().toString() == null))
        {
        ...
        localListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
          ...
          {
            CityList localCityList = (CityList)localListView.getItemAtPosition(paramAnonymous2Int);
            AddressAddActivity.this.area_id2 = localCityList.getArea_id();
            AddressAddActivity.this.textRegionID.setText(localCityList.getArea_name());
            AddressAddActivity.this.textAddressID.setText("");
            alt.dismiss();
          }
        });
        AddressAddActivity.this.loadingCityData(AddressAddActivity.this.area_id1);
      }
    });
    this.textAddressID.setOnClickListener(new View.OnClickListener()
    {
      public void onClick(View paramAnonymousView)
      {
        if ((AddressAddActivity.this.textRegionID.getText().toString().equals("")) || (AddressAddActivity.this.textRegionID.getText().toString().equals("null")) || (AddressAddActivity.this.textRegionID.getText().toString() == null))
        {
        ...
        localListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
          ...
          {
            CityList localCityList = (CityList)localListView.getItemAtPosition(paramAnonymous2Int);
            AddressAddActivity.this.city_id = localCityList.getArea_id();
            AddressAddActivity.this.textAddressID.setText(localCityList.getArea_name());
            dialog.dismiss();
            
          }
        });
        AddressAddActivity.this.loadingCityData(AddressAddActivity.this.area_id2);
      }
    });
