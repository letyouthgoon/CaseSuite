...
public class GoodsTabActivity extends TabActivity
{
		...
		implements android.view.View.OnClickListener
	{
		...
		public void onClick(View view)
		{
			...
			case 2131296346: 
				...
				Drawable drawable = getResources().getDrawable(R.drawable.goods_tab_price_bg_1);
				Drawable drawable1 = getResources().getDrawable(R.drawable.goods_tab_price_bg_2);
	...
	protected void onCreate(Bundle bundle)
	{
		...
		newIntent = new Intent(this, net.asiasofti.android.ui.type.GoodsListViewActivity.class);
		newIntent.putExtra("gc_id", s);
		newIntent.putExtra("gc_type", "");
		newIntent.putExtra("keyword", s2);
		priceIntent = new Intent(this, net.asiasofti.android.ui.type.GoodsListViewActivity.class);
		priceIntent.putExtra("gc_id", s);
		priceIntent.putExtra("gc_type", "3");
		priceIntent.putExtra("order", "1");
		priceIntent.putExtra("keyword", s2);
		numIntent = new Intent(this, net.asiasofti.android.ui.type.GoodsListViewActivity.class);
		numIntent.putExtra("gc_id", s);
		numIntent.putExtra("gc_type", "1");
		numIntent.putExtra("keyword", s2);
		manIntent = new Intent(this, net.asiasofti.android.ui.type.GoodsListViewActivity.class);
		manIntent.putExtra("gc_id", s);
		manIntent.putExtra("gc_type", "2");
		manIntent.putExtra("keyword", s2);
		tabHost = getTabHost();
		tabHost.addTab(tabHost.newTabSpec("new").setIndicator("new").setContent(newIntent));
		tabHost.addTab(tabHost.newTabSpec("price").setIndicator("price").setContent(priceIntent));
		tabHost.addTab(tabHost.newTabSpec("num").setIndicator("num").setContent(numIntent));
		tabHost.addTab(tabHost.newTabSpec("man").setIndicator("man").setContent(manIntent));
