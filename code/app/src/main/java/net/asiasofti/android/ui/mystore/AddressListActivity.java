...
public class AddressListActivity extends Activity
{
	...
	public void loadingAddressListData()
	{
		...
		RemoteDataHandler.asyncPost2(Constants.URL_ADDRESS_LIST, hashmap, new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
			...
			public void dataLoaded(ResponseData responsedata)
			{
				...
				{
					Toast.makeText(AddressListActivity.this, "数据加载失败,请稍候再试", 0).show();
					return;
				}
				...
				try
				{
					java.util.ArrayList arraylist = AddressList.newInstanceList((new JSONObject(s)).getString("address_list"));
				...
				if (s1 != null)
				{
					Toast.makeText(AddressListActivity.this, s1, 0).show();
				}
				return;
	...
	protected void onCreate(Bundle bundle)
	{
		...
		listViewAddress.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {

			public void onItemClick(AdapterView adapterview, View view, int i, long l)
			{
				AddressList addresslist = (AddressList)listViewAddress.getItemAtPosition(i);
				Intent intent = new Intent(AddressListActivity.this, net.asiasofti.android.ui.mystore.AddressEditActivity.class);
				intent.putExtra("address_id", addresslist.getAddress_id());
				startActivity(intent);
			}

		});
		textAddressAddButton.setOnClickListener(new android.view.View.OnClickListener() {

			
			public void onClick(View view)
			{
				Intent intent = new Intent(AddressListActivity.this, net.asiasofti.android.ui.mystore.AddressAddActivity.class);
				startActivity(intent);
			}
