...
public class CommendGridViewAdapter extends BaseAdapter
{
	...
	public View getView(int i, View view, ViewGroup viewgroup)
	{
		...
		viewholder.textGoodsCommendPrice.setText((new StringBuilder("￥")).append(commendlist.getGoods_price()).toString());
		(new MyBackAsynaTask(commendlist.getGoods_image_url(), viewholder.imageviewPIC)).execute(new String[0]);
		return view;
	}
