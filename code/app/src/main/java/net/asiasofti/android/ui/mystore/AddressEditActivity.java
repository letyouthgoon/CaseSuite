...
public class AddressEditActivity extends Activity
{
	...
	public void DeteleAddressData(String s)
	{
		...
		RemoteDataHandler.asyncPost2(Constants.URL_ADDRESS_DETELE, hashmap, new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
			...
			public void dataLoaded(ResponseData responsedata)
			{
				...
				if (s2 != null)
				{
					Toast.makeText(AddressEditActivity.this, s2, 0).show();
				}
				return;
	...
	public void SendCityData()
	{
		...
		if (editAddressInfo.getText().toString().equals("") || editAddressInfo.getText().toString().equals("null") || editAddressInfo.getText().toString() == null)
		{
			Toast.makeText(this, "地址信息不能为空", 0).show();
			return;
		}
		if (editJieDaoAddress.getText().toString().equals("") || editJieDaoAddress.getText().toString().equals("null") || editJieDaoAddress.getText().toString() == null)
		{
			Toast.makeText(this, "街道地址不能为空", 0).show();
			return;
		}
		if (editAddressName.getText().toString().equals("") || editAddressName.getText().toString().equals("null") || editAddressName.getText().toString() == null)
		{
			Toast.makeText(this, "姓名不能为空", 0).show();
			return;
		}
		if (editAddressMobPhone.getText().toString().equals("") || editAddressMobPhone.getText().toString().equals("null") || editAddressMobPhone.getText().toString() == null)
		{
			Toast.makeText(this, "手机号不能为空", 0).show();
			return;
		}
		if (editAddressTelPhone.getText().toString().equals("") || editAddressTelPhone.getText().toString().equals("null") || editAddressTelPhone.getText().toString() == null)
		{
			Toast.makeText(this, "固定电话不能为空", 0).show();
			return;
		} else
		{
			RemoteDataHandler.asyncPost2(Constants.URL_ADDRESS_EDIT, hashmap, new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
				...
				public void dataLoaded(ResponseData responsedata)
				{
					...
					try
					{
						s3 = (new JSONObject(s2)).getString("error");
					}
					catch (JSONException jsonexception)
					{
						jsonexception.printStackTrace();
					...
					if (s3 != null)
					{	
						Toast.makeText(AddressEditActivity.this, s3, 0).show();
					}
					return;
	...
	public void loadingAddressDetailsData(String s)
	{
		...
		hashmap.put("key", myApp.getLoginKey());
		hashmap.put("address_id", s);
		RemoteDataHandler.asyncPost2(Constants.URL_ADDRESS_DETAILS, hashmap, new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
			...
			public void dataLoaded(ResponseData responsedata)
			{
				...
				try
				{
					AddressDetails addressdetails = AddressDetails.newInstanceList((new JSONObject(s1)).getString("address_info"));
					...
					editAddressName.setText(addressdetails.getTrue_name());
					editAddressInfo.setText(addressdetails.getArea_info());
					editAddressMobPhone.setText(addressdetails.getMob_phone());
					editAddressTelPhone.setText(addressdetails.getTel_phone());
					editJieDaoAddress.setText(addressdetails.getAddress());
				}
				catch (JSONException jsonexception)
				{
					jsonexception.printStackTrace();
	...
	public void loadingCityData(String s)
	{
		...
		RemoteDataHandler.asyncPost2(Constants.URL_GET_CITY, hashmap, new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
			...
			public void dataLoaded(ResponseData responsedata)
			{
				...
				try
				{
					java.util.ArrayList arraylist = CityList.newInstanceList((new JSONObject(s1)).getString("area_list"));
	...
	protected void onCreate(Bundle bundle)
	{
		...
		textEditAddressInfo.setOnClickListener(new android.view.View.OnClickListener() {
			...
			public void onClick(View view)
			{
				...
				String s = (new StringBuilder(String.valueOf(textCityID.getText().toString()))).append(textRegionID.getText().toString()).append(textAddressID.getText().toString()).toString();
		...
		textCityID.setOnClickListener(new android.view.View.OnClickListener() {
			...
			public void onClick(View view)
			{
				android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AddressEditActivity.this);
				...
				listview.setOnItemClickListener( new android.widget.AdapterView.OnItemClickListener() {
					...
					{
						CityList citylist = (CityList)listview.getItemAtPosition(i);
		...
		textRegionID.setOnClickListener(new android.view.View.OnClickListener() {


			public void onClick(View view)
			{
				if (textCityID.getText().toString().equals("") || textCityID.getText().toString().equals("null") || textCityID.getText().toString() == null)
				{
					Toast.makeText(AddressEditActivity.this, "城市不能为空", 0).show();
					return;
				} else
				{
					android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AddressEditActivity.this);
					...
					listview.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
						...
						public void onItemClick(AdapterView adapterview, View view, int i, long l)
						{
							...
							textRegionID.setText(citylist.getArea_name());
							textAddressID.setText("");
							dialog.dismiss();
						}
		...
		textAddressID.setOnClickListener(new android.view.View.OnClickListener() {


			public void onClick(View view)
			{
				if (textRegionID.getText().toString().equals("") || textRegionID.getText().toString().equals("null") || textRegionID.getText().toString() == null)
				{
					Toast.makeText(AddressEditActivity.this, "地区不能为空", 0).show();
					return;
				} else
				{
					android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AddressEditActivity.this);
					...
					listview.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
						...
						public void onItemClick(AdapterView adapterview, View view, int i, long l)
						{
							...
							textAddressID.setText(citylist.getArea_name());
							dialog.dismiss();
						}
		...
		textSendCityButton.setOnClickListener(new android.view.View.OnClickListener() {
