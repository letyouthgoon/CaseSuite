...
public class BuyAddressListActivity extends Activity
{
	...
	public void loadingAddressListData()
	{
		...
		System.out.println((new StringBuilder("key-->>")).append(myApp.getLoginKey()).toString());
		RemoteDataHandler.asyncPost2(Constants.URL_ADDRESS_LIST, hashmap, new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
			...
			public void dataLoaded(ResponseData responsedata)
			{
				...
				{
					Toast.makeText(BuyAddressListActivity.this, "数据加载失败，请稍后重试", 0).show();
					return;
				}
...
//					return;
				...
				{
					Toast.makeText(BuyAddressListActivity.this, s1, 0).show();
					return;
				}
	...
	protected void onCreate(Bundle bundle)
	{
		...
		textAddressAddButton.setOnClickListener(new android.view.View.OnClickListener() {
			...
			public void onClick(View view)
			{
				Intent intent = new Intent(BuyAddressListActivity.this, net.asiasofti.android.ui.mystore.AddressAddActivity.class);
