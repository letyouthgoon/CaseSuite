...
public class FavoritesList
{
	...
	{
		return (new StringBuilder("FavoritesList [goods_name=")).append(goods_name).append(", goods_image_url=").append(goods_image_url).append(", goods_price=").append(goods_price).append(", fav_id=").append(fav_id).append("]").toString();
	}
}
