...
public class TypeAcitivity extends Activity {
	...
	public void loadingTypeData() {
		RemoteDataHandler.asyncStringGet(Constants.URL_GOODSCLASS,
				new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
					...
					public void dataLoaded(ResponseData responsedata) {
						if (responsedata.getCode() == 200) {
							...
							Toast.makeText(TypeAcitivity.this, "数据加载失败，请稍后重试",
									0).show();
							return;
						}
					}
	...
	protected void onCreate(Bundle bundle) {
				...
				.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView adapterview, View view,
						...
						Intent intent = new Intent(
								TypeAcitivity.this,
								net.asiasofti.android.ui.type.TypeNextActivity.class);
		...
		imageSearch.setOnClickListener(new android.view.View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent intent = new Intent(TypeAcitivity.this,
