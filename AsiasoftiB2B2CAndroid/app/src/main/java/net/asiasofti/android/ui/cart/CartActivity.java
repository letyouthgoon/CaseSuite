...
import net.asiasofti.android.ui.mystore.shoppingInterface;
...
public class CartActivity extends Activity {
	...
	public void cartDetele(String s) {
		...
		RemoteDataHandler.asyncPost2(Constants.URL_CART_DETELE, hashmap,
				new net.asiasofti.android.handler.RemoteDataHandler.Callback() {

					public void dataLoaded(ResponseData responsedata) {
						if (responsedata.getCode() != 200) {
							Toast.makeText(CartActivity.this, "数据加载失败，请稍后重试", 0)
									.show();
							return;
						}
	...
	public void loadingCartListData() {
		HashMap hashmap = new HashMap();
		hashmap.put("key", myApp.getLoginKey());
		RemoteDataHandler.asyncPost2(Constants.URL_CART_LIST, hashmap,
				new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
					...
					public void dataLoaded(ResponseData responsedata) {
						...
						try {
							...
							for (int i = 0; i <= arraylist.size() - 1; i++) {
								selectedMap.put(((CartList) arraylist.get(i))
										.getCart_id(), Boolean.valueOf(true));
								CartActivity cartactivity = CartActivity.this;
								cartactivity.sumPrice = cartactivity.sumPrice
										+ Double.parseDouble(((CartList) arraylist
												.get(i)).getGoods_price())
										* (double) Integer.parseInt(((CartList) arraylist
												.get(i)).getGoods_num());
								cartIDList.add((new StringBuilder(","))
										.append(((CartList) arraylist.get(i))
												.getCart_id())
										.append("|")
										.append(((CartList) arraylist.get(i))
												.getGoods_num()).toString());
							}

							textCartGoodsAllPrice.setText((new StringBuilder(
									String.valueOf(sumPrice))).toString());
	...
	protected void onCreate(Bundle bundle) {
		...
		imageView = (ImageView) findViewById(R.id.imageBa);
		...
		buttonVisitThe
				.setOnClickListener(new android.view.View.OnClickListener() {
					public void onClick(View view) {
						...
						// MyStoreActivity activity=new MyStoreActivity();
						// activity.setSort(1);
						i = 1;
					...
					public void onClick(View view) {
						...
						do {
							...
							s = (new StringBuilder(String.valueOf(s))).append(
									(String) cartIDList.get(i)).toString();
							i++;
						} while (true);
					}
		...
		listViewShopCart
				.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView adapterview, View view,
							int i, long l) {
						CartList cartlist = (CartList) listViewShopCart
								.getItemAtPosition(i);
						CheckBox checkbox = (CheckBox) view
								.findViewById(R.id.checkBoxCart);
						checkbox.toggle();
						selectedMap.put(cartlist.getCart_id(),
								Boolean.valueOf(checkbox.isChecked()));
						if (checkbox.isChecked()) {
							CartActivity cartactivity1 = CartActivity.this;
							cartactivity1.sumPrice = cartactivity1.sumPrice
									+ Double.parseDouble(cartlist
											.getGoods_price())
									* (double) Integer.parseInt(cartlist
											.getGoods_num());
							cartIDList.add((new StringBuilder(","))
									.append(cartlist.getCart_id()).append("|")
									.append(cartlist.getGoods_num()).toString());
						} else {
							CartActivity cartactivity = CartActivity.this;
							cartactivity.sumPrice = cartactivity.sumPrice
									- Double.parseDouble(cartlist
									...
									* (double) Integer.parseInt(cartlist
											.getGoods_num());
							cartIDList.remove((new StringBuilder(","))
									.append(cartlist.getCart_id()).append("|")
									.append(cartlist.getGoods_num()).toString());
						}
						textCartGoodsAllPrice.setText((new StringBuilder())
								.append(sumPrice).toString());
					}
				});
