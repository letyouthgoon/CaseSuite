...
public class FavoritesListActivity extends Activity implements
	...
	public void DeleteFaavoritesData(String s) {
		...
		RemoteDataHandler.asyncPost2(Constants.URL_FAVORITES_DELETE, hashmap,
				new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
					...
					public void dataLoaded(
						...
						if (paramAnonymousResponseData.getCode() == 200) {
							...
							if (str1.equals("1")) {
								Toast.makeText(FavoritesListActivity.this,
										"删除成功", 0).show();
	...
	public void loadingfavoritesListData() {
		String s = (new StringBuilder(Constants.URL_FAVORITES_LIST
				+ "&curpage=")).append(pageno).append("&page=").append(10)
				.toString();
		HashMap hashmap = new HashMap();
		hashmap.put("key", myApp.getLoginKey());
		RemoteDataHandler.asyncPost2(s, hashmap,
				new net.asiasofti.android.handler.RemoteDataHandler.Callback() {
					...
					public void dataLoaded(ResponseData responsedata) {
						if (responsedata.getCode() == 200) {
							...
							try {
								String s3 = (new JSONObject(s1))
										.getString("favorites_list");
								if (pageno == 1)
									lists.clear();
								ArrayList arraylist = FavoritesList
										.newInstanceList(s3);
		...
		listViewFavorites
				.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView adapterview, View view,
							int i, long l) {
						FavoritesList favoriteslist = (FavoritesList) listViewFavorites
								.getItemAtPosition(i);
	...
	public void onScrollStateChanged(AbsListView abslistview, int i) {
		if (lastItem == -1 + listViewFavorites.getCount() && i == 0
