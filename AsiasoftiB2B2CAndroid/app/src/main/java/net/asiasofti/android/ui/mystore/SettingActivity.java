...
public class SettingActivity extends Activity {
	...
	protected void onCreate(Bundle bundle) {
		...
		linearlayoutCleanHistoryBrowse
				.setOnClickListener(new android.view.View.OnClickListener() {

					public void onClick(View view) {
						HistoryBrowse.deleteAll();
						Toast.makeText(SettingActivity.this, "删除浏览历史成功", 0)
								.show();
					}
		...
		linearlayoutFeekBask
				.setOnClickListener(new android.view.View.OnClickListener() {

					public void onClick(View view) {
						Intent intent = new Intent(
								SettingActivity.this,
								net.asiasofti.android.ui.mystore.FeekBaskActivity.class);
						startActivity(intent);
					}
		...
		linearlayoutCleanPhoto
				.setOnClickListener(new android.view.View.OnClickListener() {

					public void onClick(View view) {
						delAllFile(Constants.CACHE_DIR_IMAGE);
						Toast.makeText(SettingActivity.this, "删除缓存图片成功", 0)
								.show();
					}
