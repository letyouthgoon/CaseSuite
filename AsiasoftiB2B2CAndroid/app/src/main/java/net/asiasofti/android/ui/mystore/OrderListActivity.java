...
public class OrderListActivity extends Activity implements
	...
	public void loadingfavoritesListData() {
		String s = (new StringBuilder(Constants.URL_ORDER_LIST + "&curpage="))
				.append(pageno).append("&page=").append(10).toString();
						...
						if (responsedata.getCode() == 200) {
							...
							try {
								...
								System.out.println((new StringBuilder(
										"order_group_list-->")).append(s3)
										.toString());
								ArrayList arraylist = OrderGroupList2
										.newInstanceList(s3);
							...
							if (s2 != null)
								...
								Toast.makeText(OrderListActivity.this, s2, 0)
										.show();
							return;
						}
						Toast.makeText(OrderListActivity.this, "数据加载失败，请稍后重试",
								0).show();
						return;
					}
	...
	protected void onCreate(Bundle bundle) {
		...
		adapter = new OrderGroupListViewAdapter(this,OrderListActivity.this);
		lists = new ArrayList();
	...
	public void onScrollStateChanged(AbsListView abslistview, int i) {
		if (lastItem == -1 + listViewOrder.getCount() && i == 0
