...
public class CartList {
	...
	public CartList(String s, String s1, String s2, String s3, String s4,
	...
	public String toString() {
		return (new StringBuilder("CartList [bl_id=")).append(bl_id)
				.append(", buyer_id=").append(buyer_id)
				.append(", goods_price=").append(goods_price)
				.append(", cart_id=").append(cart_id).append(", goods_num=")
				.append(goods_num).append(", goods_id=").append(goods_id)
				.append(", goods_image_url=").append(goods_image_url)
				.append(", goods_name=").append(goods_name)
				.append(", store_id=").append(store_id)
				.append(", goods_image=").append(goods_image)
				.append(", store_name=").append(store_name)
				.append(", premiums=").append(premiums).append("]").toString();
	}
}
